...
/**
 * Enlace con variantes y escala en wrapper interno:
 * - El <a> (outer) NO lleva fondo/padding/borde; sólo ring/focus y layout externo.
...
export function ActionLink({
  ...
  return (
    <a
      ...
      target={target}
      rel={safeRel}
      // Outer: nada de bg/border/padding para evitar “doble botón”
      className={[
        "group inline-flex items-center cursor-pointer justify-center focus:outline-none",
